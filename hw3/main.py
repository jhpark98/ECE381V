...
if __name__ == '__main__':
    ...
    VI.run(epsilon)
    trajectory_VI = VI.simulate(start)

    ''' visualization '''    
    print("\n\n")
    value_table, policy_table = VI.get_results()
    print("plotting a heatmap of the optimal value function ...")
    gen_heatmap_value(value_table, policy_table, trajectory_VI, plot=False, save=True, name=f"{fig_dir}/vi_value.png", title="Value Iteration")
    ...
    PI.run(epsilon)
    trajectory_PI = VI.simulate(start)

    ''' visualization '''    
    print("\n\n")
    value_table, policy_table = PI.get_results()
    print("plotting a heatmap of the optimal value function ...")
    gen_heatmap_value(value_table, policy_table, trajectory_PI, plot=False, save=True, name=f"{fig_dir}/pi_value.png", title="Policy Iteration")
    print("plotting a heatmap of the optimal policy ...")
